...
export const A_Commande = () => {
    ...
    const fetchCommandes = async () => {
      try {
        const res = await axios.get(
          "http://localhost:3001/api/admin/get-commandes"
        );
  ...
  const updateEtat = async (id, nouvelEtat) => {
    try {
      await axios.put(`http://localhost:3001/api/commandes/${id}`, {
        etat: nouvelEtat,
      });
      setCommandes((prev) =>
  ...
  const filteredCommandes =
    filter === "all" ? commandes : commandes.filter((c) => c.etat === filter);
    ...
    <div className="home_page">
      <div className="home_content Mycommande_page">
        <PageHeader
          ...
          description="Gérez et suivez toutes les commandes de votre boutique"
              ...
              <div className="filters">
                {[
                  ...
                  },
                  {
                    key: "validée",
                    label: "Validées",
                    count: commandes.filter((c) => c.etat === "validée").length,
                  },
                  {
                    key: "en_livraison",
                    label: "En livraison",
                    count: commandes.filter((c) => c.etat === "en_livraison")
                      .length,
                  },
                  { key: "livrée", label: "Livrées", count: stats.livree },
                  {
                    key: "annulée",
                    label: "Annulées",
                    count: commandes.filter((c) => c.etat === "annulée").length,
                  },
                ].map((f) => (
                  <button
                    key={f.key}
                            ...
                            <td data-label="Statut">
                              ...
                              <div className="progress-indicator">
                                <div
                                  ...
                                  style={{
                                    width: `${
                                      (getProgressStatus(commande.etat)
                                        .currentStep /
                                        getProgressStatus(commande.etat)
                                          .totalSteps) *
                                      100
                                ...
                                <div className="action-buttons">
                                  {commande.etat === "en_attente" && (
                                    <Button
                                      ...
                                      size="sm"
                                      onClick={() =>
                                        updateEtat(commande.id, "validée")
                                      }
                                    >
                                      Valider
                                    </Button>
                                  ...
                                  {commande.etat === "validée" && (
                                    <Button
                                      ...
                                      size="sm"
                                      onClick={() =>
                                        updateEtat(commande.id, "en_livraison")
                                      }
                                    >
                                      Livraison
                                    </Button>
                                  ...
                                  {commande.etat !== "annulée" &&
                                    commande.etat !== "livrée" && (
                                      <Button
                                        ...
                                        size="sm"
                                        onClick={() =>
                                          updateEtat(commande.id, "annulée")
                                        }
                                      >
                                        Annuler
                                      </Button>
          ...
          <Modal.Body>
            {selectedCommande && (
              <div className="commande-detail">
                ...
                {selectedCommande.paiement.startsWith("mobile_money_") &&
                  selectedCommande.paymentData && (
                      ...
                      <div className="payment-info">
                        <div className="info-card">
                          <div className="info-row">
                            <span>Opérateur:</span>
                            <strong>
                              {selectedCommande.paymentData.operatorName}
                            </strong>
                          </div>
                          <div className="info-row">
                            <span>Numéro vendeur:</span>
                            <strong>
                              {selectedCommande.paymentData.sellerNumber}
                            </strong>
                          </div>
                          <div className="info-row">
                            <span>Numéro client:</span>
                            <strong>
                              {selectedCommande.paymentData.clientNumber}
                            </strong>
                          </div>
                          <div className="info-row">
                            <span>Nom client:</span>
                            <strong>
                              {selectedCommande.paymentData.clientName}
                            </strong>
                          </div>
                          <div className="info-row">
                            ...
                            <strong>
                              {formatDate(
                                selectedCommande.paymentData.timestamp
                              )}
                            </strong>
                          </div>
                  ...
                  <div className="detail-section">
                    ...
                    <div className="address-info">
                      ...
                      <div>
                        ...
                        {selectedCommande.adresseLivraison.codePostal}
                      </div>
                      <div>
                        ...
                        <div key={idx} className="product-item">
                          <div className="product-info">
                            ...
                            <div className="product-variant">
                              {produit.options
                                ? Object.values(produit.options).join(" / ")
                                : "Aucune option"}
                            </div>
                          </div>
